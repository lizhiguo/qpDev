package com.qp.common.event.config;

import com.qp.common.event.annotation.HibernateEventListener;
import com.qp.common.event.exception.AssignableParameterException;
import com.qp.common.event.exception.InvalidParameterCountException;
...
public class AnnotatedHibernateEventListenerInvoker implements
    ...
    private <T extends Annotation> void register(Object bean, Method method, Class<T> annotationType) throws InvalidParameterCountException, AssignableParameterException {
